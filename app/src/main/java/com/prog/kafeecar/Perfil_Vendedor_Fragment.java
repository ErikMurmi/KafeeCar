...
public class Perfil_Vendedor_Fragment extends Fragment {
    ...
    public void verPerfil(){
        try{
            ...
            Toast.makeText(mainview.getContext(), "Error 177: No se puede mostrar la información", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void verPerfilEditable(){
        try{
            ...
            Toast.makeText(mainview.getContext(), "Error 179: No se puede mostrar la información", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void editarVendedor(){
        ...
        if(!clave_str.isEmpty() && !repetirclave_str.isEmpty()){
            if(clave_str.length()<8 || repetirclave_str.length()<8){
                Toast.makeText(mainview.getContext(), "La clave debe contener 8 caracteres mínimo", Toast.LENGTH_SHORT).show();
                textoclave.setText("");
        ...
        if (vacios == 0 && invalidos == 0) {
            ...
            try {
                ...
                Toast.makeText(mainview.getContext(), "Error 180: No se puede mostrar la información", Toast.LENGTH_SHORT).show();
            }
        }else{
