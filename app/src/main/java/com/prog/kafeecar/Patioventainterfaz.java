...
public class Patioventainterfaz extends AppCompatActivity {
    ...
    public static void cargarDatos() throws Exception {
        ...
        //patioventa.aniadirUsuario((new Vendedor("1732221032.jpg", 8, 17, 13, patioventa, "Elizabeth Perez", "1732221032", "1721053207", "eli.p@gmail.com", "eli12345", sdf.parse("09-05-2000"))), "Vendedor");
        patioventa.aniadirUsuario((new Vendedor("1723456909.jpg", 8, 17, 13, patioventa, "Eliazbeth Montalvo", "1723456909", "0987654321", "eli.m@gmail.com", "kafeecar", sdf.parse("19-02-2000"))), "Vendedor");
        ...
        patioventa.aniadirUsuario((new Vendedor("1721053208.jpg", 8, 17, 13, patioventa, "Jessica Alvarez", "1721053208", "0923837273", "jessy.v@gmail.com", "jessy12345", sdf.parse("08-4-2001"))), "Vendedor");
        ...
        patioventa.aniadirUsuario(new Cliente("Nikita", "1712345698", "0981234567", "nikita@gmail.com", "kafeecar", sdf.parse("12-2-1997"), "1712345698.jpg"), "Cliente");
    ...
    public void aniadirCliente(View v) {
        ...
        if (vacios == 0 && invalidos == 0) {
            ...
            try {
                ...
                Toast.makeText(Patioventainterfaz.this, "Error 304: Fallo al obtener la fecha", Toast.LENGTH_SHORT).show();
            }
            ...
            try {
                ...
                if(cliente_comprobacion== null){
                    ...
                    usuarioActual = cliente_comprobacion;
                    irAplicacion("CLIENTE");
                }
            } catch (Exception e) {
                Toast.makeText(Patioventainterfaz.this, "Error 305: Búsqueda fallida del cliente", Toast.LENGTH_SHORT).show();
            }
        }else{
    ...
    public void registrarAdministrador() {
        ...
        if (vacios == 0 && invalidos ==0) {
            ...
            try {
                ...
                Toast.makeText(Patioventainterfaz.this, "Error 306: Fallo al obtener la fecha", Toast.LENGTH_SHORT).show();
            }
            ...
            try {
                ...
                Toast.makeText(Patioventainterfaz.this, "Error 307: No se pudo completar el registro (Administrador)", Toast.LENGTH_SHORT).show();
            }
